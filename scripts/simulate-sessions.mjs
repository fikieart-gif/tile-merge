 ...
 * profile: math4 | easy_b_1 | norm_b_1 | normal8 | hard | hard_b_1 | hard_b_2 | hard_b_3 (один профиль на весь прогон, как в UI)
 */
import fs from "fs";
...
const VALID_PROFILES = ["math4", "easy_b_1", "norm_b_1", "normal8", "hard", "hard_b_1", "hard_b_2", "hard_b_3"];
